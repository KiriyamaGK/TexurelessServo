...
def train_policy(img_size, model, num_train_steps, optimizer, criterion, num_epochs=10, batch_size=16, data_cfg=None,train_cfg=None, save_path=None, episode_idx=None, filter_by_attribute=None,is_ewc_epoch = False,ewc_batch_penalty = 0.00):
    # 创建训练数据集
    ...
    for epoch in range(num_epochs):
        ...
        train_loss_dict = bc_algorithm.train(train_loader, num_train_steps=num_train_steps, is_ewc_epoch = is_ewc_epoch, ewc_batch_penalty = ewc_batch_penalty)
